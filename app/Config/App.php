...
class App extends BaseConfig
{
	 ...
	 * 
	 * See more in: https://www.php.net/manual/pt_BR/timezones.php
	 *
	 * @var string
	 */
	// public $appTimezone = 'America/Chicago';
	public $appTimezone = 'America/Fortaleza';
	 ...
	 * @var integer
	 */
	public $sessionExpiration = 7200; // 7200seg = 120min = 2h
	 ...
	 * @var integer
	 */
	public $sessionTimeToUpdate = 300; // 300seg = 5min
